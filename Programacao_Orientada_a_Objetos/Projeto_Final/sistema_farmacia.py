    ...
    def __init__(self, preset=True, log=True):
        ...
        if preset:
            ...
            if True:
                ...
                mfC = MedicamentoFito(**lista_medicamentos_fito[2])
                ...
                self.cadastro_medicamentos.adicionar_medicamento(mfC)
